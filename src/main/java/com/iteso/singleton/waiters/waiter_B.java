...
public class waiter_B extends waiter {
    ...
    public boolean addDrink(Drink drink, int table_num){
        ...
        System.out.println("Bebida " + drink.getDescription() + drink.getName() +" agregada a la cuenta de la mesa " + tableOrder.tableName +" por el mesero B");
        return true;
    }
    ...
    public boolean addDish(Dish dish, int table_num) {
        ...
        System.out.println("Platillo " + dish.getDescription() + dish.getName() +" agregada a la cuenta de la mesa " + tableOrder.tableName +" por el mesero B");
        return true;
    }
