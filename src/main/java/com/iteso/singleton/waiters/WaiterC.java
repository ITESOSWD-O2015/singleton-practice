 ...
 */
public class WaiterC extends Waiter {
    private String name;
    TableOrder table;
    ...
    public void addDrink(int tableNumber, Drink drink) {
        ...
        System.out.println("I, WaiterC, am adding " + drink.getName() + " to table " + tableNumber);
    ...
    public void addDish(int tableNumber, Dish dish) {
        ...
        System.out.println("I, WaiterC, am adding " + dish.getName() + " to table " + tableNumber);
