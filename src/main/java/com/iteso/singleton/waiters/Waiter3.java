...
public class Waiter3 extends Waiter {
    ...
    public void addDrink(int tableNumber, Drink drink) {
        ...
        System.out.println("Soy el mesero 3 y estoy sirviendo una bebida");
    ...
    public void addDish(int tableNumber, Dish dish) {
        ...
        System.out.println("Soy el mesero 3 y estoy sirviendo un platillo");
    ...
    public void giveCheck(int tableNumber) {
        ...
        System.out.println("Soy el mesero 3 y estoy trayendo la cuenta");
