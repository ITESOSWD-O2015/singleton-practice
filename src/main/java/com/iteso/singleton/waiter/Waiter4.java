 ...
 */
public class Waiter4 extends Waiter {
    ...
    public boolean addDrink(int tableNum, Drink drink) {
        ...
        System.out.println("El mesero 1 llevo la bebida " + drink.getName() + "a la mesa numero"+ tableNum );
    ...
    public boolean addDish(int tableNum, Dish dish) {
        ...
        System.out.println("El mesero 1 llevo el platillo " + dish.getName() + "a la mesa numero"+ tableNum );
        table.addDish(dish);
        return true;
    }
    ...
    public boolean cuenta(int tableNum) {
        ...
        System.out.println("El mesero 1 lleva la cuenta");
        getTable(tableNum);
        table.printCheck();
        table.clearDrinks();
        table.clearDishes();
